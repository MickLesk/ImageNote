...
`;var rt=[["year",31536e3],["month",2592e3],["week",604800],["day",86400],["hour",3600],["minute",60]];function he(a,e,t=new Date){let i=Math.round((a.getTime()-t.getTime())/1e3);if(!Number.isFinite(i))return"";let o=new Intl.RelativeTimeFormat(e,{numeric:"auto"}),n=Math.abs(i);for(let[r,s]of rt)if(n>=s)return o.format(Math.round(i/s),r);return o.format(0,"second")}var L=class extends Error{constructor(t,i){super(t);this.code=i}code};async function je(a,e,t){if(a.fetchWithAuth)return a.fetchWithAuth(e,t);let i=a.auth?.data?.access_token??"";return fetch(e,{...t,headers:{Authorization:`Bearer ${i}`}})}function $e(a){if(a.status===413)throw new L("too large","too_large");if(a.status===401||a.status===403)throw new L("forbidden","forbidden");if(!a.ok)throw new L(`${a.status} ${a.statusText}`,"http")}async function st(a,e,t=.85,i){if(!e&&!i||!a.type.startsWith("image/")||a.type==="image/svg+xml"||a.type==="image/gif")return a;let o;try{o=await createImageBitmap(a,{imageOrientation:"from-image"})}catch{return a}let{width:n,height:r}=o,s=0,l=0,c=n,d=r;i&&i>0&&(n/r>i?(c=Math.round(r*i),s=Math.round((n-c)/2)):(d=Math.round(n/i),l=Math.round((r-d)/2)));let u=Math.max(c,d),p=e&&u>e?e/u:1;if(p===1&&c===n&&d===r)return o.close(),a;let h=document.createElement("canvas");h.width=Math.max(1,Math.round(c*p)),h.height=Math.max(1,Math.round(d*p));let f=h.getContext("2d");if(!f)return o.close(),a;f.drawImage(o,s,l,c,d,0,0,h.width,h.height),o.close();let k=a.type==="image/png",v=k?"image/png":"image/jpeg",g=await new Promise(y=>h.toBlob(y,v,k?void 0:t));if(!g)return a;let b=k?a.name:a.name.replace(/\.[a-z0-9]+$/i,"")+".jpg";return new File([g],b,{type:v})}async function dt(a,e){let t=new FormData;t.append("file",e);let i=await je(a,"/api/image/upload",{method:"POST",body:t});return $e(i),`/api/image/serve/${(await i.json()).id}/original`}async function Ue(a,e,t){let i=t.trim().replace(/^\/+|\/+$/g,""),o=`${S}media_source/local${i?`/${i}`:""}`,n=e.name.replace(/[^A-Za-z0-9._-]+/g,"_")||"picture.jpg",r=new File([e],`${Date.now()}-${n}`,{type:e.type}),s=new FormData;s.append("media_content_id",o),s.append("file",r);let l=await je(a,"/api/media_source/local_source/upload",{method:"POST",body:s});return $e(l),(await l.json()).media_content_id}function ie(a,e,t,i="memo"){let o=e.type.includes("mp4")||e.type.includes("aac")?"m4a":e.type.includes("ogg")?"ogg":e.type.includes("wav")?"wav":"webm",n=new File([e],`${i}.${o}`,{type:e.type||"audio/webm"});return Ue(a,n,t)}function oe(){let a=["audio/webm;codecs=opus","audio/webm","audio/mp4","audio/ogg;codecs=opus"],e=window.MediaRecorder;return e?.isTypeSupported?a.find(t=>e.isTypeSupported?.(t))??"":""}async function ne(a,e,t){let i=await st(e,t.maxSize,t.quality,t.cropAspect);return t.target==="media"?Ue(a,i,t.folder):dt(a,i)}var me=/^(\s*)[-*+]\s+\[([ xX])\]\s?(.*)$/;function Ve(a){let e=a.split(`
`),t=[],i=[],o=[],n=()=>{i.length&&i.some(s=>s.trim()!=="")&&t.push({type:"markdown",text:i.join(`
`)}),i=[]},r=()=>{o.length&&t.push({type:"checklist",items:o}),o=[]};return e.forEach((s,l)=>{let c=me.exec(s);c?(n(),o.push({line:l,checked:c[2]!==" ",text:c[3]})):(r(),i.push(s))}),n(),r(),t}function qe(a){return a.split(`
`).some(e=>me.test(e))}function Ke(a,e,t){let i=a.split(`
`),o=me.exec(i[e]??"");return o?(i[e]=`${o[1]}- [${t?"x":" "}] ${o[3]}`,i.join(`
`)):a}function ge(a){return/\{\{|\{%/.test(a)}function fe(a){let e=a.trim();if(!e)return null;let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(t)return new Date(Number(t[1]),Number(t[2])-1,Number(t[3]),23,59,59,999);let i=new Date(e.includes("T")?e:e.replace(" ","T"));return Number.isNaN(i.getTime())?null:i}function ae(a,e=new Date){let t=fe(a);return t!==null&&t.getTime()<e.getTime()}var be={yellow:"#fff3a8",green:"#d4f5cd",blue:"#d6ebff",pink:"#ffd9e6",orange:"#ffe0b8",purple:"#e6dcff",grey:"#e9e9ee"};function Ge(a){let e=a.trim().toLowerCase();return e?be[e]??a.trim():null}function We(a){let e=/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.exec(a.trim()),t=255,i=255,o=255;if(e){let r=e[1];r.length===3&&(r=r.split("").map(s=>s+s).join("")),t=Number.parseInt(r.slice(0,2),16),i=Number.parseInt(r.slice(2,4),16),o=Number.parseInt(r.slice(4,6),16)}else{let r=/^rgba?\((\d+)[,\s]+(\d+)[,\s]+(\d+)/i.exec(a.trim());r&&(t=Number(r[1]),i=Number(r[2]),o=Number(r[3]))}return(.299*t+.587*i+.114*o)/255>.55?"#1f1f1f":"#ffffff"}var Xe=`
...
<ha-card>
  <div class="stage" tabindex="0" role="button">
    <div class="scene">
      <div class="face face-a current">${Xe}</div>
      <div class="face face-b hidden-face">${Xe}</div>
    </div>
    <div class="overlay">
...
<div class="version">Pinboard ${V}</div>`,mt=`
.pages {
  margin-bottom: 16px;
}
.pages-label,
...
`,le=class extends HTMLElement{_root;_config;_hass;_lang="en";_built=!1;_pageIndex=0;_pageForm;_cardForm;_chips;_previewImg;_preview;_fileInput;_status;_clearButton;_uploadButton;_removePageButton;_moveLeftButton;_moveRightButton;_uploading=!1;_previewToken=0;_selectedMarker=-1;_canvasImg;_previewCard;_dragIndex=-1;_importing=!1;_recorder;_recordTimer;constructor(){super(),this._root=this.attachShadow({mode:"open"})}setConfig(e){this._config={...e};let t=O(this._config).length;this._pageIndex>=t&&(this._pageIndex=t-1),this._render()}set hass(e){this._hass=e;let t=te(e),i=t!==this._lang;this._lang=t,this._pageForm&&(this._pageForm.hass=e),this._cardForm&&(this._cardForm.hass=e),this._previewCard&&(this._previewCard.hass=e),i?this._render():this._updatePreview()}get hass(){return this._hass}_pages(){return this._config?O(this._config):[{}]}_page(){return this._pages()[this._pageIndex]??{}}_kindOf(e){let t=R(e)||e.kind==="image",i=j(e)||e.kind==="note",o=B(e)||e.kind==="audio";return[t,i,o].filter(Boolean).length>1?"both":o?"audio":i?"note":"image"}_slideCount(e){return ee(e.map(J)).length}_withPage(e,t){let i={...this._config??{type:""}},o=this._pages().map(n=>({...n}));return o[e]=ke(t),this._withPages(i,o)}_withPages(e,t){let i={...e};for(let o of F)o!=="title"&&delete i[o];for(let o of xe)delete i[o];if(t.length<=1){let o=ke(t[0]??{});for(let n of F){if(n==="title"){o.title&&!i.title&&(i.title=o.title);continue}o[n]!==void 0&&(i[n]=o[n])}}else i.slides=t.map(ke);return i}_addPage(e){let t=this._pages().map(i=>({...i}));this._slideCount(t)>=10||(t.push(e==="image"?{}:{kind:e}),this._pageIndex=t.length-1,this._emit(this._withPages(this._config??{type:""},t)))}_removePage(){let e=this._pages().map(t=>({...t}));e.length<=1||(e.splice(this._pageIndex,1),this._pageIndex=Math.min(this._pageIndex,e.length-1),this._emit(this._withPages(this._config??{type:""},e)))}_movePage(e){let t=this._pages().map(n=>({...n})),i=this._pageIndex,o=i+e;o<0||o>=t.length||([t[i],t[o]]=[t[o],t[i]],this._pageIndex=o,this._emit(this._withPages(this._config??{type:""},t)))}_reorder(e,t){let i=this._pages().map(n=>({...n}));if(e<0||e>=i.length||t<0||t>=i.length)return;let[o]=i.splice(e,1);i.splice(t,0,o),this._pageIndex=t,this._emit(this._withPages(this._config??{type:""},i))}async _importFolder(){let e=this._hass,t=this._root.querySelector(".import-folder"),i=this._root.querySelector(".import-status");if(!e||!t||this._importing)return;let o=(s,l)=>m(this._lang,s,l),n=t.value.trim().replace(/^\/+|\/+$/g,""),r=n.startsWith(S)?n:`${S}media_source/local${n?`/${n}`:""}`;this._importing=!0,i&&(i.textContent=o("editor_uploading"),i.classList.remove("error"));try{let l=((await e.callWS({type:"media_source/browse_media",media_content_id:r})).children??[]).filter(u=>u.media_class==="image"||(u.media_content_type??"").startsWith("image/")),c=this._pages().map(u=>({...u})),d=0;for(let u of l){if(this._slideCount(c)>=10)break;c.push({image:u.media_content_id}),d++}d&&(this._pageIndex=c.length-1,this._emit(this._withPages(this._config??{type:""},c))),i&&(i.textContent=d?o("editor_import_done",{count:d}):o("editor_import_none",{folder:n||"/media"}))}catch(s){i&&(i.textContent=`${o("editor_import_failed")}: ${s instanceof Error?s.message:String(s)}`,i.classList.add("error"))}finally{this._importing=!1;let s=this._root.querySelector(".import");s&&(s.disabled=!1)}}_renderAudioEditor(e){let t=this._root.querySelector(".audio-editor");if(!t||(t.classList.toggle("hidden",!e),!e))return;let i=n=>m(this._lang,n),o=(n,r)=>{let s=t.querySelector(n);s&&(s.textContent=r)};o(".audio-label",i("editor_audio")),o(".audio-help",i("editor_audio_help")),o(".record-btn span",i(this._recorder?"editor_stop":"editor_record")),o(".upload-audio span",i("editor_upload_audio")),t.querySelector(".record-btn")?.classList.toggle("active",!!this._recorder),this._updateAudioPreview()}_updateAudioPreview(){let e=this._root.querySelector(".audio-preview");if(!e)return;let t=this._page(),i;if(t.audio_entity&&this._hass){let n=this._hass.states[t.audio_entity];i=n&&n.state!=="unknown"?n.state:""}else i=typeof t.audio=="object"&&t.audio!==null?t.audio.media_content_id:t.audio;if(!i){e.removeAttribute("src");return}if(!i.startsWith(S)){e.getAttribute("src")!==i&&(e.src=i);return}if(!this._hass)return;let o=i;this._hass.callWS({type:"media_source/resolve_media",media_content_id:o,expires:86400}).then(n=>{e.dataset.mediaId!==o&&(e.dataset.mediaId=o,e.src=n.url)}).catch(()=>e.removeAttribute("src"))}_setAudioStatus(e,t=!1){let i=this._root.querySelector(".audio-editor-status");i&&(i.textContent=e,i.classList.toggle("error",t))}async _uploadAudioFile(e,t="memo"){let i=this._hass;if(!i)return;let o=n=>m(this._lang,n);this._setAudioStatus(o("editor_uploading"));try{let n=this._config?.upload_folder??_.upload_folder,r=await ie(i,e,n,t),s={...this._page(),audio:r};delete s.kind,this._emit(this._withPage(this._pageIndex,s)),this._setAudioStatus(o("editor_upload_done"))}catch(n){let r=n instanceof L?n.code:"network",s=r==="too_large"?o("editor_upload_too_large"):r==="forbidden"?o("editor_upload_forbidden"):n instanceof Error?n.message:String(n);this._setAudioStatus(`${o("editor_upload_failed")}: ${s}`,!0)}}async _toggleRecord(){let e=(l,c)=>m(this._lang,l,c);if(this._recorder){this._recorder.state!=="inactive"&&this._recorder.stop();return}let t=window.MediaRecorder;if(!t||!navigator.mediaDevices?.getUserMedia){this._setAudioStatus(e("micUnsupported"),!0);return}let i;try{i=await navigator.mediaDevices.getUserMedia({audio:!0})}catch{this._setAudioStatus(e("micDenied"),!0);return}let o=oe(),n=o?new t(i,{mimeType:o}):new t(i),r=[],s=Date.now();n.addEventListener("dataavailable",l=>{l.data.size>0&&r.push(l.data)}),n.addEventListener("stop",()=>{i.getTracks().forEach(l=>l.stop()),window.clearInterval(this._recordTimer),this._recorder=void 0,this._renderAudioEditor(!0),r.length&&this._uploadAudioFile(new Blob(r,{type:n.mimeType||o||"audio/webm"}),`memo-${Date.now()}`)}),this._recorder=n,n.start(),this._renderAudioEditor(!0),this._recordTimer=window.setInterval(()=>{let l=Math.round((Date.now()-s)/1e3);this._setAudioStatus(e("recording",{seconds:l})),l>=180&&this._recorder?.state!=="inactive"&&this._recorder?.stop()},500)}_updatePreviewCard(){let e=this._previewCard;if(!(!e||!this._config))try{e.setConfig({...this._config,type:this._config.type||`custom:${E}`}),this._hass&&(e.hass=this._hass)}catch{}}_selectPage(e){this._pageIndex=e,this._render()}_ensureForm(){customElements.get("ha-form")||window.loadCardHelpers?.().then(e=>{e.createCardElement({type:"entities",entities:[]}).constructor.getConfigElement?.()}).catch(()=>{})}_build(){this._ensureForm(),this._root.innerHTML=`<style>${Oe}${mt}</style>${ht}`;let e=o=>this._root.querySelector(o)??void 0;this._pageForm=e(".page-form"),this._cardForm=e(".card-form"),this._chips=e(".chips"),this._preview=e(".preview"),this._previewImg=e(".preview img"),this._fileInput=e(".file"),this._status=e(".status"),this._clearButton=e(".clear"),this._uploadButton=e(".upload"),this._removePageButton=e(".remove-page"),this._moveLeftButton=e(".move-left"),this._moveRightButton=e(".move-right"),this._canvasImg=e(".marker-canvas img"),this._root.querySelector(".marker-canvas")?.addEventListener("click",o=>this._onCanvasClick(o)),this._root.querySelector(".import")?.addEventListener("click",()=>{this._importFolder()}),this._root.querySelector(".import-folder")?.addEventListener("keydown",o=>{o.key==="Enter"&&this._importFolder()});let t=this._root.querySelector(".preview-card");t&&customElements.get(E)&&(this._previewCard=document.createElement(E),this._previewCard&&t.append(this._previewCard)),this._root.querySelector(".play")?.addEventListener("click",()=>this._previewCard?.flip()),this._root.querySelector(".record-btn")?.addEventListener("click",()=>{this._toggleRecord()});let i=this._root.querySelector(".audio-file");this._root.querySelector(".upload-audio")?.addEventListener("click",()=>i?.click()),i?.addEventListener("change",()=>{let o=i.files?.[0];i.value="",o&&this._uploadAudioFile(o)}),this._pageForm?.addEventListener("value-changed",this._onPageValueChanged),this._cardForm?.addEventListener("value-changed",this._onCardValueChanged),this._uploadButton?.addEventListener("click",()=>this._fileInput?.click()),this._fileInput?.addEventListener("change",()=>{let o=this._fileInput?.files?.[0];o&&this._upload(o),this._fileInput&&(this._fileInput.value="")}),this._clearButton?.addEventListener("click",()=>{this._emit(this._withPage(this._pageIndex,{...this._page(),image:void 0,image_entity:void 0}))}),this._removePageButton?.addEventListener("click",()=>this._removePage()),this._moveLeftButton?.addEventListener("click",()=>this._movePage(-1)),this._moveRightButton?.addEventListener("click",()=>this._movePage(1)),this._previewImg?.addEventListener("error",()=>{this._preview?.classList.remove("has-image")}),this._built=!0}_render(){if(!this._config)return;this._built||this._build();let e=(v,g)=>m(this._lang,v,g),t=(v,g)=>{let b=this._root.querySelector(v);b&&(b.textContent=g)};t(".pages-label",e("editor_pages")),t(".pages-help",e("editor_pages_help")),t(".picture-label",e("editor_image")),t(".picture-help",e("editor_image_help")),t(".upload span",e("editor_upload")),t(".clear span",e("editor_clear")),t(".remove-page span",e("editor_remove_page")),t(".move-left span",e("editor_move_left")),t(".move-right span",e("editor_move_right"));let i=this._pages(),o=this._slideCount(i)>=10;this._chips&&(this._chips.replaceChildren(),i.forEach((v,g)=>{let b=this._kindOf(v),y=document.createElement("button");y.type="button",y.className=`chip${g===this._pageIndex?" active":""}`,y.dataset.kind=b;let A=document.createElement("ha-icon");A.setAttribute("icon",b==="note"?"mdi:note-text-outline":b==="audio"?"mdi:microphone-outline":b==="both"?"mdi:image-text":"mdi:image-outline");let M=document.createElement("span");M.textContent=`${g+1} · ${e(`editor_kind_${b}`)}`,y.append(A,M),y.title=e("editor_drag_hint"),y.addEventListener("click",()=>this._selectPage(g)),y.draggable=!0,y.addEventListener("dragstart",T=>{this._dragIndex=g,y.classList.add("dragging"),T.dataTransfer?.setData("text/plain",String(g)),T.dataTransfer&&(T.dataTransfer.effectAllowed="move")}),y.addEventListener("dragend",()=>{this._dragIndex=-1,y.classList.remove("dragging")}),y.addEventListener("dragover",T=>{this._dragIndex<0||this._dragIndex===g||(T.preventDefault(),y.classList.add("drop-target"))}),y.addEventListener("dragleave",()=>y.classList.remove("drop-target")),y.addEventListener("drop",T=>{T.preventDefault(),y.classList.remove("drop-target");let ce=this._dragIndex>=0?this._dragIndex:Number(T.dataTransfer?.getData("text/plain"));this._dragIndex=-1,!(!Number.isInteger(ce)||ce===g)&&this._reorder(ce,g)}),this._chips?.append(y)}));let n=this._root.querySelector(".add-row");if(n){n.replaceChildren();for(let v of["image","note","audio"]){let g=document.createElement("button");g.type="button",g.className=`chip add add-${v}`,g.innerHTML='<ha-icon icon="mdi:plus"></ha-icon><span></span>',g.querySelector("span").textContent=e(v==="note"?"editor_add_note":v==="audio"?"editor_add_audio":"editor_add_page"),g.disabled=o,g.addEventListener("click",()=>this._addPage(v)),n.append(g)}}let r=this._root.querySelector(".max-note");r&&(r.textContent=o?e("editor_max_slides"):"");let s=this._root.querySelector(".import-folder");s&&(s.placeholder=e("editor_import"),s.title=e("editor_import_help"),!s.value&&!s.dataset.touched&&(s.value=this._config?.upload_folder??_.upload_folder,s.addEventListener("input",()=>s.dataset.touched="1",{once:!0}))),t(".import span",e("editor_import_button"));let l=this._root.querySelector(".import");l&&(l.disabled=o||this._importing),t(".preview-label",e("editor_preview")),t(".preview-help",e("editor_preview_help")),t(".play span",e("editor_play")),this._updatePreviewCard();let c=this._kindOf(this._page()),d=this._page(),u=c==="image"||R(d),p=c==="audio"||B(d);this._root.querySelector(".picture")?.classList.toggle("hidden",!u),this._renderMarkers(u),this._renderAudioEditor(p),this._removePageButton?.classList.toggle("hidden",i.length<=1),this._moveLeftButton?.classList.toggle("hidden",i.length<=1||this._pageIndex===0),this._moveRightButton?.classList.toggle("hidden",i.length<=1||this._pageIndex>=i.length-1);let h=v=>{let g=`editor_${v.name}_help`,b=e(g);return b===g?"":b},f={actions_help:"editor_actions_help",visible_help:"editor_visible_help",page_actions_help:"editor_page_actions_help"},k=v=>e(f[v.name]??`editor_${v.name}`);this._pageForm&&(this._pageForm.hass=this._hass,this._pageForm.schema=this._pageSchema(i.length>1),this._pageForm.data=this._pageData(),this._pageForm.computeLabel=k,this._pageForm.computeHelper=h),this._cardForm&&(this._cardForm.hass=this._hass,this._cardForm.schema=this._cardSchema(),this._cardForm.data=this._cardData(),this._cardForm.computeLabel=k,this._cardForm.computeHelper=h),this._updatePreview()}_pageSchema(e){let t=s=>m(this._lang,s),i=[],o=this._page(),n=this._kindOf(o),r=(s,l,c,d)=>({name:s,type:"expandable",flatten:!0,icon:l,title:t(`editor_section_${s}`),expanded:c,schema:d});return e&&i.push({name:"page_title",selector:{text:{}}}),(n==="image"||R(o))&&i.push(r("picture","mdi:image-outline",!0,[{name:"image",selector:{text:{}}},{name:"image_entity",selector:{entity:{filter:[{domain:"image"},{domain:"camera"},{domain:"person"},{domain:"input_text"},{domain:"text"}]}}}])),(n!=="audio"||j(o))&&i.push(r("note","mdi:note-text-outline",n==="note"||n==="both",[{name:"note",selector:{text:{multiline:!0}}},{name:"todo_entity",selector:{entity:{filter:[{domain:"todo"}]}}},{name:"note_entity",selector:{entity:{}}},{name:"note_attribute",selector:{attribute:{}},context:{filter_entity:"note_entity"}}])),(n==="audio"||B(o))&&i.push(r("audio","mdi:microphone-outline",!0,[{name:"audio",selector:{text:{}}},{name:"audio_entity",selector:{entity:{filter:[{domain:"input_text"},{domain:"text"}]}}}])),i.push(r("display","mdi:palette-outline",!!(o.expires||o.color),[{name:"display_grid",type:"grid",flatten:!0,schema:[{name:"expires",selector:{datetime:{}}},{name:"color",selector:{select:{mode:"dropdown",custom_value:!0,options:[{value:"",label:t("color_none")},...Object.keys(be).map(s=>({value:s,label:t(`color_${s}`)}))]}}}]}]),r("visibility","mdi:eye-outline",!!o.visible,[{name:"visible_entity",selector:{entity:{}}},{name:"visible_state",selector:{text:{}}},{name:"visible_help",type:"constant",value:""}]),r("page_actions","mdi:gesture-tap",!!(o.hold_action||o.double_tap_action),[{name:"page_actions_help",type:"constant",value:""},{name:"hold_action",selector:{ui_action:{actions:se,default_action:"none"}}},{name:"double_tap_action",selector:{ui_action:{actions:se,default_action:"none"}}}])),i}_cardSchema(){let e=n=>m(this._lang,n),t=(n,r)=>n.map(s=>({value:s,label:e(`${r}_${s}`)})),i=(n,r)=>({name:n,type:"grid",flatten:!0,schema:r}),o=(n,r,s,l,c)=>({name:n,type:"expandable",flatten:!0,icon:r,title:s,expanded:l,schema:c});return[{name:"title",selector:{text:{}}},o("appearance","mdi:palette-outline",e("editor_appearance"),!0,[i("appearance_layout",[{name:"layout",selector:{select:{mode:"dropdown",options:t(K,"layout")}}},{name:"columns",selector:{number:{min:0,max:8,step:1,mode:"box"}}}]),i("appearance_grid",[{name:"transition",selector:{select:{mode:"dropdown",options:t(N,"transition")}}},{name:"direction",selector:{select:{mode:"dropdown",options:t(I,"direction")}}},{name:"default_side",selector:{select:{mode:"dropdown",options:t(z,"side")}}},{name:"aspect_ratio",selector:{select:{mode:"dropdown",custom_value:!0,options:Ae.map(n=>({value:n,label:n==="auto"?e("ratio_auto"):n}))}}},{name:"image_fit",selector:{select:{mode:"dropdown",options:t(q,"fit")}}},{name:"duration",selector:{number:{min:0,max:5e3,step:50,mode:"box",unit_of_measurement:"ms"}}}]),i("appearance_toggles",[{name:"show_title",selector:{boolean:{}}},{name:"show_hint",selector:{boolean:{}}},{name:"show_updated",selector:{boolean:{}}},{name:"ken_burns",selector:{boolean:{}}}]),i("appearance_notes",[{name:"note_style",selector:{select:{mode:"dropdown",options:t(G,"note_style")}}},{name:"expired_slides",selector:{select:{mode:"dropdown",options:t(W,"expired")}}}])]),o("navigation","mdi:swap-horizontal",e("editor_section_navigation"),!1,[i("navigation_grid",[{name:"auto_flip",selector:{number:{min:0,max:3600,step:1,mode:"box",unit_of_measurement:"s"}}},{name:"show_navigation",selector:{boolean:{}}},{name:"swipe",selector:{boolean:{}}},{name:"hover_flip",selector:{boolean:{}}}])]),o("notes","mdi:format-list-checks",e("editor_section_notes"),!1,[i("notes_grid",[{name:"checklist",selector:{boolean:{}}},{name:"checklist_writeback",selector:{boolean:{}}},{name:"todo_add",selector:{boolean:{}}},{name:"todo_show_completed",selector:{boolean:{}}}])]),o("upload_settings","mdi:folder-image",e("editor_upload_settings"),!1,[{name:"upload_target",selector:{select:{mode:"dropdown",options:t(_t,"upload_target")}}},{name:"upload_folder",selector:{text:{}}},i("upload_grid",[{name:"upload_max_size",selector:{number:{min:0,max:8e3,step:10,mode:"box",unit_of_measurement:"px"}}},{name:"upload_crop",selector:{boolean:{}}},{name:"show_camera",selector:{boolean:{}}},{name:"show_record",selector:{boolean:{}}}])]),o("actions","mdi:gesture-tap",e("editor_section_actions"),!1,[{name:"actions_help",type:"constant",value:""},{name:"hold_action",selector:{ui_action:{actions:se,default_action:"none"}}},{name:"double_tap_action",selector:{ui_action:{actions:se,default_action:"none"}}}])]}_pageData(){let e=this._page(),t=typeof e.image=="object"&&e.image!==null?e.image.media_content_id:e.image??"";return{page_title:e.title??"",image:t,image_entity:e.image_entity??"",note:e.note??"",note_entity:e.note_entity??"",note_attribute:e.note_attribute??"",todo_entity:e.todo_entity??"",expires:e.expires??"",color:e.color??"",audio:typeof e.audio=="object"&&e.audio!==null?e.audio.media_content_id:e.audio??"",audio_entity:e.audio_entity??"",visible_entity:de(e)?.entity??"",visible_state:Qe(de(e)?.state),hold_action:e.hold_action??{action:"none"},double_tap_action:e.double_tap_action??{action:"none"}}}_cardData(){let e=this._config??{type:""},t={..._,...ye};for(let[i,o]of Object.entries(e))xe.includes(i)||F.includes(i)&&i!=="title"||(t[i]=o);return t}_onPageValueChanged=e=>{if(e.stopPropagation(),!this._config)return;let t=e.detail.value??{},i={...this._page()};for(let[o,n]of Object.entries(t)){if(o==="visible_entity"||o==="visible_state")continue;let r=o==="page_title"?"title":o;if(!F.includes(r)||r==="kind"||r==="markers")continue;let s=(r==="hold_action"||r==="double_tap_action")&&n?.action==="none";n==null||n===""||s?delete i[r]:i[r]=n}if("visible_entity"in t||"visible_state"in t){let o=String(t.visible_entity??de(i)?.entity??"").trim(),n=String(t.visible_state??Qe(de(i)?.state)).trim();if(!o)delete i.visible;else{let r={entity:o};n&&(r.state=n.includes(",")?n.split(",").map(s=>s.trim()).filter(Boolean):n),i.visible=r}}i.kind==="note"&&j(i)&&delete i.kind,i.kind==="image"&&R(i)&&delete i.kind,this._emit(this._withPage(this._pageIndex,i))};_onCardValueChanged=e=>{if(e.stopPropagation(),!this._config)return;let t=e.detail.value??{},i={...this._config};for(let[o,n]of Object.entries(t)){if(o==="type"||xe.includes(o)||F.includes(o)&&o!=="title")continue;let r=o in _?_[o]:ye[o],s=(o in _||o in ye)&&(n===r||typeof n=="object"&&n!==null&&JSON.stringify(n)===JSON.stringify(r));n==null||n===""||s?delete i[o]:i[o]=n}this._emit(i)};_emit(e){let t={};for(let[i,o]of Object.entries(e))o!=null&&o!==""&&(t[i]=o);this._config=t,this._render(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}async _upload(e){let t=this._hass;if(!t||this._uploading)return;let i=o=>m(this._lang,o);this._uploading=!0,this._setStatus(i("editor_uploading"),!1),this._uploadButton&&(this._uploadButton.disabled=!0);try{let o=this._config??{},n=await ne(t,e,{target:o.upload_target==="media"?"media":"image",folder:o.upload_folder??_.upload_folder,maxSize:o.upload_max_size??_.upload_max_size,cropAspect:o.upload_crop?$(o.aspect_ratio??_.aspect_ratio)??void 0:void 0});this._emit(this._withPage(this._pageIndex,{...this._page(),image:n,image_entity:void 0})),this._setStatus(i("editor_upload_done"),!1)}catch(o){let n=o instanceof L?o.code:"network",r=n==="too_large"?i("editor_upload_too_large"):n==="forbidden"?i("editor_upload_forbidden"):o instanceof Error?o.message:String(o);this._setStatus(`${i("editor_upload_failed")}: ${r}`,!0)}finally{this._uploading=!1,this._uploadButton&&(this._uploadButton.disabled=!1)}}_markers(){let e=this._page().markers;return Array.isArray(e)?e.map(t=>({...t})):[]}_setMarkers(e){let t={...this._page()};e.length?t.markers=e:delete t.markers,this._emit(this._withPage(this._pageIndex,t))}_onCanvasClick(e){if(e.target.closest(".pin"))return;let i=this._canvasImg;if(!i||!i.getAttribute("src"))return;let o=i.getBoundingClientRect();if(!o.width||!o.height)return;let n=Math.round(Math.min(100,Math.max(0,(e.clientX-o.left)/o.width*100))*10)/10,r=Math.round(Math.min(100,Math.max(0,(e.clientY-o.top)/o.height*100))*10)/10,s=this._markers();if(this._selectedMarker>=0&&this._selectedMarker<s.length)s[this._selectedMarker]={...s[this._selectedMarker],x:n,y:r};else{if(s.length>=20)return;s.push({x:n,y:r}),this._selectedMarker=s.length-1}this._setMarkers(s)}_renderMarkers(e){let t=this._root.querySelector(".markers-editor"),i=this._root.querySelector(".marker-canvas .pins"),o=this._root.querySelector(".marker-list");if(!t||!i||!o)return;let n=u=>m(this._lang,u),r=this._page(),s=!!r.image||!!r.image_entity;if(t.classList.toggle("hidden",!e||!s),!e||!s)return;let l=t.querySelector(".markers-label"),c=t.querySelector(".markers-help");l&&(l.textContent=n("editor_markers")),c&&(c.textContent=n("editor_markers_help"));let d=this._markers();if(this._selectedMarker>=d.length&&(this._selectedMarker=-1),i.replaceChildren(),o.replaceChildren(),d.forEach((u,p)=>{let h=document.createElement("button");h.type="button",h.className=`pin${p===this._selectedMarker?" selected":""}`,h.style.left=`${u.x}%`,h.style.top=`${u.y}%`,h.textContent=String(p+1),h.addEventListener("click",b=>{b.stopPropagation(),this._selectedMarker=this._selectedMarker===p?-1:p,this._renderMarkers(!0)}),i.append(h);let f=document.createElement("div");f.className=`marker-row${p===this._selectedMarker?" selected":""}`;let k=document.createElement("button");k.type="button",k.className="marker-number",k.textContent=String(p+1),k.addEventListener("click",()=>{this._selectedMarker=this._selectedMarker===p?-1:p,this._renderMarkers(!0)});let v=(b,y)=>{let A=document.createElement("input");return A.type="text",A.className=`marker-${b}`,A.placeholder=y,A.value=u[b]??"",A.addEventListener("change",()=>{let M=this._markers(),T=A.value.trim();T?M[p]={...M[p],[b]:T}:delete M[p][b],this._setMarkers(M)}),A},g=document.createElement("button");g.type="button",g.className="icon-button",g.title=n("editor_marker_remove"),g.innerHTML='<ha-icon icon="mdi:close"></ha-icon>',g.addEventListener("click",()=>{let b=this._markers();b.splice(p,1),this._selectedMarker=-1,this._setMarkers(b)}),f.append(k,v("label",n("editor_marker_label")),v("icon",n("editor_marker_icon")),v("entity",n("editor_marker_entity")),g),o.append(f)}),!d.length){let u=document.createElement("div");u.className="marker-empty",u.textContent=n("editor_marker_none"),o.append(u)}}_setStatus(e,t){this._status&&(this._status.textContent=e,this._status.classList.toggle("error",t))}_updatePreview(){let e=this._previewImg,t=this._preview;if(!e||!t||!this._config)return;let i=this._page(),o=++this._previewToken,n=l=>{o===this._previewToken&&(l?(e.src=l,t.classList.add("has-image"),this._canvasImg&&(this._canvasImg.src=l)):(e.removeAttribute("src"),t.classList.remove("has-image"),this._canvasImg?.removeAttribute("src")),this._clearButton?.classList.toggle("hidden",!l&&!i.image_entity))},r=i.image;if(i.image_entity&&this._hass){let l=this._hass.states[i.image_entity],c=i.image_entity.split(".")[0];if(c==="input_text"||c==="text")r=l&&l.state!=="unknown"?l.state:"";else{let d=l?.attributes.entity_picture;n(typeof d=="string"?d:"");return}}let s=typeof r=="object"&&r!==null?r.media_content_id:typeof r=="string"&&r.startsWith(S)?r:void 0;if(!s){n(typeof r=="string"?r:"");return}if(!this._hass){n("");return}this._hass.callWS({type:"media_source/resolve_media",media_content_id:s,expires:86400}).then(l=>n(l.url)).catch(()=>n(""))}};function de(a){let e=a.visible;return Array.isArray(e)?e[0]:e}function Qe(a){return Array.isArray(a)?a.join(", "):a??""}function ke(a){let e={};for(let t of F){let i=a[t];i!=null&&i!==""&&(e[t]=i)}return e}customElements.get(E)||customElements.define(E,re);customElements.get(D)||customElements.define(D,le);window.customCards=window.customCards??[];window.customCards.some(a=>a.type===E)||window.customCards.push({type:E,name:Ee,description:Te,preview:!0,documentationURL:Le});console.info(`%c Pinboard %c ${V} `,"color: #fff; background: #2c5364; font-weight: 600; border-radius: 4px 0 0 4px; padding: 2px 6px;","color: #2c5364; background: #e6f0f3; font-weight: 500; border-radius: 0 4px 4px 0; padding: 2px 6px;");export{re as PinboardCard,le as PinboardCardEditor};
