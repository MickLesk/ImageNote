...
const checks = [
  [`version banner v${pkg.version}`, bundle.includes(`ImageNote Card v${pkg.version}`)],
  ["defines imagenote-card", bundle.includes('"imagenote-card"')],
  ["defines imagenote-card-editor", bundle.includes('"imagenote-card-editor"')],
  ...
  ["bundle below 200 kB", bundle.length < 200_000],
];
